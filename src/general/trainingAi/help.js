...
async function main(Texto) {
  ...
  const config = {
    ...
    systemInstruction: [
      {
        text: `Eu quero que tu escrevas um relatório formal (será enviado como email) para instituições de apoio sem fim lucrativos, de como eles poderiam ajudar a eliminar uma zona de perigo à malária. Deixa o texto bem detalhado de como eles poderiam ajudar especificamente aquela zona. Eu irei passar um texto que essas organizações disseram sobre como poderiam ajudar, vou passar o nome da organização, também vou passar os objetos que conseguimos identificar naquela zona e o nível de perigo que a IA classificou.
